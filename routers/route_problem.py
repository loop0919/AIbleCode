...
async def get_problem(id: str):
    ...
    if problem:
        return problem
    raise HTTPException(status_code=404, detail=f"Problem of ID:{id} not found")
...
async def update_problem(id: str, problem: ProblemBody):
    ...
    if res:
        return res
    raise HTTPException(status_code=404, detail=f"Failed to Update Problem of ID:{id}")
...
async def delete_problem(id: str):
    ...
    raise HTTPException(status_code=404, detail=f"Failed to Delete Problem of ID:{id}")
